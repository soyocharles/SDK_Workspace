...
typedef struct {
    ...
    uint32_t TX_A_BACKOFF_COUNTER;
    uint32_t TX_A_BACKOFF_COUNTER_n_bits;
    uint32_t TX_A_BACKOFF_COUNTER_bin_pt;
    // uint32_t TX_A_BACKOFF_COUNTER_attr;
    uint32_t TX_CD_BACKOFF_COUNTERS;
    uint32_t TX_CD_BACKOFF_COUNTERS_n_bits;
    uint32_t TX_CD_BACKOFF_COUNTERS_bin_pt;
    // uint32_t TX_CD_BACKOFF_COUNTERS_attr;
    ...
    uint32_t TXRX_START_TIMESTAMPS_FRAC;
    uint32_t TXRX_START_TIMESTAMPS_FRAC_n_bits;
    uint32_t TXRX_START_TIMESTAMPS_FRAC_bin_pt;
    // uint32_t TXRX_START_TIMESTAMPS_FRAC_attr;
    uint32_t Tx_Ctrl_Status;
    uint32_t Tx_Ctrl_Status_n_bits;
    uint32_t Tx_Ctrl_Status_bin_pt;
    // uint32_t Tx_Ctrl_Status_attr;
    uint32_t Status;
    uint32_t Status_n_bits;
    uint32_t Status_bin_pt;
    // uint32_t Status_attr;
    uint32_t TX_CTRL_D_PARAMS;
    uint32_t TX_CTRL_D_PARAMS_n_bits;
    uint32_t TX_CTRL_D_PARAMS_bin_pt;
    // uint32_t TX_CTRL_D_PARAMS_attr;
    uint32_t TX_CTRL_D_GAINS;
    uint32_t TX_CTRL_D_GAINS_n_bits;
    uint32_t TX_CTRL_D_GAINS_bin_pt;
    // uint32_t TX_CTRL_D_GAINS_attr;
    uint32_t TX_CTRL_C_PARAMS;
    uint32_t TX_CTRL_C_PARAMS_n_bits;
    uint32_t TX_CTRL_C_PARAMS_bin_pt;
    // uint32_t TX_CTRL_C_PARAMS_attr;
    uint32_t TX_CTRL_C_GAINS;
    uint32_t TX_CTRL_C_GAINS_n_bits;
    uint32_t TX_CTRL_C_GAINS_bin_pt;
    // uint32_t TX_CTRL_C_GAINS_attr;
    ...
    uint32_t TU_TARGET_LSB;
    uint32_t TU_TARGET_LSB_n_bits;
    uint32_t TU_TARGET_LSB_bin_pt;
    // uint32_t TU_TARGET_LSB_attr;
    ...
    uint32_t TU_TARGET_MSB;
    uint32_t TU_TARGET_MSB_n_bits;
    uint32_t TU_TARGET_MSB_bin_pt;
    // uint32_t TU_TARGET_MSB_attr;
    uint32_t Control;
