...
typedef struct {
    ...
    uint32_t CFO_EST_TIME_DOMAIN;
    uint32_t CFO_EST_TIME_DOMAIN_n_bits;
    uint32_t CFO_EST_TIME_DOMAIN_bin_pt;
    // uint32_t CFO_EST_TIME_DOMAIN_attr;
    uint32_t Status;
    ...
    uint32_t LTS_Corr_PeakType_Thresh;
    uint32_t LTS_Corr_PeakType_Thresh_n_bits;
    uint32_t LTS_Corr_PeakType_Thresh_bin_pt;
    // uint32_t LTS_Corr_PeakType_Thresh_attr;
    uint32_t CHAN_EST_SMOOTHING;
    uint32_t CHAN_EST_SMOOTHING_n_bits;
    uint32_t CHAN_EST_SMOOTHING_bin_pt;
    // uint32_t CHAN_EST_SMOOTHING_attr;
