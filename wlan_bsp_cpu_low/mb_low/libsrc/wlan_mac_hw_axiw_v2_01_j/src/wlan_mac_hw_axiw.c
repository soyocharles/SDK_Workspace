...
xc_status_t xc_wlan_mac_hw_axiw_getshmem(xc_iface_t *iface, const char *name, void **shmem)
{
    ...
    } else if (strcmp("TX_A_BACKOFF_COUNTER", name) == 0) {
        *shmem = (void *) & _config_table->TX_A_BACKOFF_COUNTER;
    } else if (strcmp("TX_CD_BACKOFF_COUNTERS", name) == 0) {
        *shmem = (void *) & _config_table->TX_CD_BACKOFF_COUNTERS;
    ...
    } else if (strcmp("TX_CTRL_D_PARAMS", name) == 0) {
        *shmem = (void *) & _config_table->TX_CTRL_D_PARAMS;
    } else if (strcmp("TX_CTRL_D_GAINS", name) == 0) {
        *shmem = (void *) & _config_table->TX_CTRL_D_GAINS;
    ...
    } else if (strcmp("TU_TARGET_LSB", name) == 0) {
        *shmem = (void *) & _config_table->TU_TARGET_LSB;
    ...
    } else if (strcmp("TU_TARGET_MSB", name) == 0) {
        *shmem = (void *) & _config_table->TU_TARGET_MSB;
